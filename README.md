...
This repository also hosts **[qfieldESRI](qfieldesri/)**, a companion plugin
...
classes and field aliases into QGIS edit widgets, value maps and relations —
and syncs field edits back into the geodatabase.

It reuses QFieldSync's architecture and its `QFieldSync/*` property vocabulary,
so a project generated by qfieldESRI can still be maintained from QGIS with
QFieldSync. It does not depend on QGIS or PyQt; the GeoPackage and the `.qgs`
project are written directly.

- [qfieldesri/README.md](qfieldesri/README.md) — installation and usage (Spanish)
- [qfieldesri/ANALISIS.md](qfieldesri/ANALISIS.md) — how each QFieldSync piece
  was mapped, and what could not be carried over
